...
import static com.crm.utils.ConstantUtils.getConstantValue;
...
public final class NumberUtils {
     ...
     * formatString: #,###0.00
     */
    public static final String DECIMAL_FORMAT_N2 = getConstantValue("#,###0.00");
    /**
     * formatString: #,###0.00##
     */
    public static final String DECIMAL_FORMAT_N4 = getConstantValue("#,###0.00##");
    /**
     * 精度：2
     */
    public static final String FORMAT_TYPE_N2 = getConstantValue("n2");
    /**
     * 精度：4
     */
    public static final String FORMAT_TYPE_N4 = ConstantUtils.getConstantValue("n4");
    ...
    public static boolean checkMoney(String allienceAmount,Long currentAmount){
        BigDecimal b1 = new BigDecimal(allienceAmount);
        BigDecimal b2 = new BigDecimal(currentAmount);
        return 0==b1.compareTo(b2);
    }
    private static final  String base ="0123456789qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM";
    public static String codeRandom(int length){
//        String r = Long.toString(System.currentTimeMillis())+Long.toString(Math.round(Math.random()*100000));
//        Random random = new Random(Long.valueOf(r).longValue());
    ...
    public static void main(String[] args) {
        int count=0;
            ...
            for (int i = 0; i <10000000 ; i++) {
                ...
                //String code = generateShortUuid(8);
                list.add(code);
                set.add(code);
            }
